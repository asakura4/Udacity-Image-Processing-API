...
describe('image process test - ', function () {
    it('function output images successfully', function (done) { return __awaiter(void 0, void 0, void 0, function () {
        var fileName, width, height, inputFile, newFileName, outputFile, result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    expect(fileHelper_1.default.isFileExist(outputFile)).toBeTruthy();
                    done();
                    return [2 /*return*/];
            }
        });
